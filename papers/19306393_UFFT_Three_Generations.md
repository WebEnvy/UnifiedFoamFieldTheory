# Three Generations from the BCC Lattice of Truncated Octahedra

## Why the Standard Model Has Exactly Three Generations of Fermions
...
**Keywords:** generation problem, fermion generations, BCC lattice, truncated octahedron, Schur's lemma, T₁u band splitting, Bloch theorem, inter-type torsion, foam field theory, UFFT
...
[3] Martin, L. (2026). The UFFT Core Framework v10. github.com/WebEnvy/UnifiedFoamFieldTheory.
