# The Void Channel: Entanglement from the Antipodal Map

## The Complete Hamiltonian H = L + ηV and the Two Propagation Channels of the Foam
...
The void coupling is derived from the bulk geometry: η_sq = exp(−2√2) = 0.059 for sq-sq pairs and η_hx = exp(−√6) = 0.086 for hx-hx pairs. The void corrections are O(η) ≈ 6−9%, consistent with the known sub-leading corrections to the coupling constants. The trace is conserved (Σλ = 72 with or without void), expressing pressure conservation across the bulk.

**Keywords:** void channel, antipodal map, entanglement, Bell correlations, two-channel propagator, parity, boson-fermion distinction, Higgs mechanism, decoherence, foam field theory, UFFT
