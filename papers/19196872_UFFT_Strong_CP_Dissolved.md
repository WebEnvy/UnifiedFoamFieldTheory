# The Strong CP Problem Dissolved by Foam Torsion Dynamics

## θ_QCD = 0 as the Geometric Ground State
...
**Keywords:** strong CP problem, QCD vacuum angle, neutron electric dipole moment, axion, topological charge, torsion dynamics, foam field theory
...
This paper was developed in collaboration with Claude (Anthropic). Ideas, direction, and framework: Luke Martin. AI role: derivation formulation, literature identification, document composition.
