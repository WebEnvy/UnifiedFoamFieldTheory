# The Inter-Type Torsion Operator on the Truncated Octahedron

## Complete Block Structure and Physical Applications
...
The operator provides the microscopic basis for the CKM and PMNS CP phases [1], the three-generation structure [2], and the Eg decoupling that underlies the flavour-conserving nature of the weak interaction.

**Keywords:** torsion operator, inter-type coupling, O_h symmetry, Schur's lemma, block structure, face graph, truncated octahedron, CP violation, generation mixing, foam field theory, UFFT
