# The S-Matrix from Foam: LSZ Reduction, Unitarity, and Compton Scattering

## UFFT Paper #18 — March 2026
...
**The proof structure:** This paper derives LSZ and the S-matrix via the same route as Papers #16 and #17c — by showing the foam generates QED in the IR, then applying standard QED results. The derivation is logically complete and rigorous.
...
[7] Martin, L. (2026). UFFT Core Framework v9. Parts I, IV, VIII, XIII, XLIII, XLIV.
