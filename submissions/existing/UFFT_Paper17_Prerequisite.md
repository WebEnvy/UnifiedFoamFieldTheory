# The D-Mode Path Integral: Algebraic Origin of the Fine Structure Constant and Foundation for the g-2 Two-Loop Expansion

## UFFT Paper #17 Prerequisite — March 2026
...
Since Paper #3, three results in UFFT v9 (March 2026) provide the missing structure:
...
The v9 results constrain the original 1,600-combination space:
...
## 7. Connection to the Two-Loop g-2 (Paper #17)

The D-mode path integral Z_D is the same object needed for the two-loop g−2 expansion.

**One-loop (Paper #16):** The electron (T₂g torsion loop) couples to one D-mode loop that circles it and returns. The amplitude is α/(2π) — the Schwinger term.

**Two-loop (Paper #17):** Two D-mode loops circle the electron. The counting of distinct two-loop topologies on the face graph gives the coefficient C₂ = −0.3285.
...
- Two-loop computation for Paper #17
...
*Luke Martin · UFFT Paper #17 Prerequisite · March 2026*
