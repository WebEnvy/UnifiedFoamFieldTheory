# The Path Integral from Planck-Scale Foam

## How Feynman Rules Emerge from Face Graph Torsion Walks
...
**Keywords:** path integral, Feynman rules, lattice QFT, face graph, torsion walk, heat kernel, Klein-Gordon propagator, fermion doubling, gauge invariance, renormalisation group, truncated octahedron, BCC lattice, foam field theory, UFFT
