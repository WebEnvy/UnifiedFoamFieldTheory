# The Two-Loop Anomalous Magnetic Moment: Complete Derivation from Foam

## UFFT Paper #17c — March 2026
...
α = 1/137.035999055, derived from the heat kernel Z_D = Tr[exp(−L/|G|²)] on the face adjacency graph of the Kelvin cell (Paper #17a). Agreement with experiment: 0.21 ppb (1.4σ).
...
## 4. The Structural Identification (from Paper #17b)

Paper #17b identified the foam origin of each term in C₂. These identifications are now elevated from "structural correspondence" to "derived consequence":
...
The identifications in Paper #17b are now proven: because the foam generates QED, and QED evaluates these integrals to these specific values with these specific foam constants appearing as the relevant scales.
...
- 1/(2π) = one D-mode loop closure (Paper #16)
...
| Feynman rules from foam | QED Feynman rules emerge from foam IR limit (Papers #8, #16, #17a) |
...
[8] Martin, L. (2026). UFFT Core Framework v9. Parts IV, VIII, XVI, XXXVII, XLII.
