# Total Torsion Identity and Foam Equilibration Timescale

## Two Exact Results from the Truncated Octahedron Face Graph
...
**Keywords:** dihedral angle, torsion, total curvature, spectral gap, equilibration time, truncated octahedron, face Laplacian, Planck time, foam field theory, UFFT
