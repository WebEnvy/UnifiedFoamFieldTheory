# UFFT Aufbau Ordering from Foam Geometry
## Deriving the Periodic Table Structure from the Face Laplacian

**Author:** Luke Martin, Independent Researcher, Sydney
**Date:** March 2026
**Framework:** Unified Foam Field Theory (UFFT)
**Depends on:** Paper #9 (Face Laplacian Spectrum), Part XXII (Particle Hierarchy)
...
1. **The nuclear potential is Coulombic** (V ∝ 1/r), derived from the foam pressure gradient (Part III of UFFT).
...
| 3 | Foam pressure gradient → Coulomb potential V ∝ 1/r | **DERIVED** (Part III) |
...
Today's colour-frequency calculations (see companion working paper) established:
