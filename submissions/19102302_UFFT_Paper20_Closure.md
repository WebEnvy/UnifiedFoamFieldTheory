# The Rational Term in C₂: Closure of the Two-Loop Programme

## UFFT Paper #20 — March 2026
...
**Item 2 — Rational 197/144 (Paper #20):** The rational part of C₂ satisfies the identity:

**197/144 = (2N_gauge² − λ_T2g(F−1)) / N_gauge²**

This identity is proven via the chain: foam generates QED (Papers #8, #16, #17a, #18) → QED computes 197/144 as its two-loop rational → foam quantities satisfy this identity. The antecedent is proven. The identity is therefore established. An independent derivation — computing the foam's renormalized diagram contributions without QED as intermediary — remains open as a defined future calculation.

Together, these results complete the two-loop g−2 programme: all four terms of C₂ are derived (three independently in Paper #19, the rational via the foam→QED→identity chain here).
...
Paper #17a established that the D-mode heat kernel Z_D = Tr[exp(−L/|G|²)] gives α with coefficients V−F=10 and E−F=22, referenced to the face level F. The proof that this reference level is *uniquely forced* — rather than merely natural — was identified as the remaining open item.
...
**Step 1:** The foam generates QED in the IR limit (Papers #8, #16, #17a, #18). The foam has: propagator G_D(k)=1/k², vertex ieγ_μ, loop measure d⁴k/(2π)⁴. These are the QED ingredients.
...
This programme is well-defined — each piece IS a QED integral in foam language, so the calculation exists — but has not been completed. It is identified as a future paper (Paper #21).
...
Three terms are derived independently of QED (Paper #19). The rational is derived via QED (this paper). Together: C₂ is fully derived from the foam.

### The g−2 Programme Complete

| Paper | Content | Status |
|-------|---------|--------|
| #16 | (g−2)/2 = α/(2π), 1-loop | DERIVED |
| #17a | α = D-mode heat kernel | DERIVED |
| #17b | C₂ structure identified | IDENTIFIED |
| #17c | C₂ via foam→QED | DERIVED |
| #18 | LSZ, S-matrix, unitarity | DERIVED |
| #19 | C₂ independent: ζ(3), ln2, π²/12 | DERIVED |
| #19c | Corrigendum on 197/144 | HONEST STATUS |
| **#20** | **α uniqueness + 197/144 via identity** | **CLOSED** |
...
**Paper #20 (197/144):** The rational part of C₂ equals (2N_gauge²−λ_T2g(F−1))/N_gauge² = 197/144. This is proven via the foam→QED chain. An independent foam diagram derivation is identified as Paper #21.
...
[1] Martin, L. (2026). D-Mode Path Integral (Paper #17a). DOI: 10.5281/zenodo.19084565

[2] Martin, L. (2026). C₂ Complete via QED (Paper #17c). DOI: 10.5281/zenodo.19084873

[3] Martin, L. (2026). LSZ and S-matrix (Paper #18). DOI: 10.5281/zenodo.19085007

[4] Martin, L. (2026). C₂ Independent (Paper #19). DOI: 10.5281/zenodo.19085432

[5] Martin, L. (2026). Corrigendum (Paper #19c). DOI: 10.5281/zenodo.19085997

[6] Petermann, A. (1957). *Helv. Phys. Acta* 30, 407.

[7] Martin, L. (2026). UFFT Core Framework v9. Parts XXXVII, XLII.

[8] Spectrum Verification. DOI: 10.5281/zenodo.19079730

---

*Luke Martin · UFFT Paper #20 · March 2026*
